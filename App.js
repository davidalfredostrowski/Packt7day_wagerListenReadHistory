...
constructor(props){
 ...
 //       }
	...
	async loadBlockchainData(){
		...
		const web3 = new Web3(new Web3.providers.HttpProvider("http://ec2-54-188-138-249.us-west-2.compute.amazonaws.com:8545"))
		...
		contract.options.address = "0xf26A15100b5fC1C68096dF1FC8C1Dca72500fDF0";
...
//console.log("events.returnedValues['0']", events.returnValues["guess"])
	...
	console.log("array.length ===>", array.length)
        ...
        console.log("returned values",obj[array[1]].returnValues);
